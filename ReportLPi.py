...
if __name__ == "__main__":
    ...
    # python.exe .\ReportLPi.py -s .\instance\
    ...
    report_file = "report_lpi_" + time.strftime("%H_%M_%S.csv", time.localtime())
    head = "idx; inst; m; j; cmax_init; time_init; "
    head += "cmax_swap; time_ls; reduction; \n"
    write_file(report_file, head)

    for file in files:

        print(f"({aux}/{n_files}) - {file}", end = " - ")
